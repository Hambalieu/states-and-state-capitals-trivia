...
public class StatesAndCapitals
{
    ...
    public void testStatesAndCapitals() throws IOException
    {
        ...
        Boolean doAllStatesHaveAnAnthem = states.stream().allMatch(stateInfo -> stateInfo.getStateAnthem().contains("anthem"));
        ...
        Map<String, Long> numberOfStatesByTimeZone = states.stream().collect(groupingBy(value -> value.getTimeZones().toString(), counting()));
        ...
        Map<String, Long> numberOfStateCapitalsByTimeZone = states.stream().collect((groupingBy(value -> value.getCapital().getTimeZone(), counting())));
